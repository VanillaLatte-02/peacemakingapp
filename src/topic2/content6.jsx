...
export default function Topic2Content6() {
    ...
    <div className="topic2-container">
      <div className="topic2-header">
        ...
        <div className="topic2-arrows desktop-only">
          ...
          <Link to="/topic2/content5" className="topic2-arrow-btn" >
            <MdChevronLeft />
          </Link>
          <Link to="/topic2/content7" className="topic2-arrow-btn" >
            <MdChevronRight />
          </Link>
