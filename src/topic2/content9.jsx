...
export default function Topic2Content9() {
  const lang = localStorage.getItem('lang') || 'en'

  const navigate = useNavigate();
  const handlers = useSwipeable({
    onSwipedLeft: () => navigate('/topic2/content10'),
    onSwipedRight: () => navigate('/topic2/content8'),
    trackMouse: true
  });
  return (
    <div className="topic2-container">
      <div className="topic2-header">
        ...
        <div className="topic2-arrows desktop-only">
          ...
          <Link to="/topic2/content8" className="topic2-arrow-btn" >
            <MdChevronLeft />
          </Link>
