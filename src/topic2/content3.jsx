...
export default function Topic2Content3() {
  const lang = localStorage.getItem('lang') || 'id'

  const navigate = useNavigate();
  const handlers = useSwipeable({
    onSwipedLeft: () => navigate('/topic2/content4'),
    onSwipedRight: () => navigate('/topic2/content2'),
    trackMouse: true
  });
  return (
    <div className="topic2-container">
      <div className="topic2-header">
        ...
        <div className="topic2-arrows desktop-only">
          ...
          <Link to="/topic2/content2" className="topic2-arrow-btn" >
            <MdChevronLeft />
          </Link>
