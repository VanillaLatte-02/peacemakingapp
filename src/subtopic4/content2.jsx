...
export default function Subtopic4Content2() {
  const lang = localStorage.getItem('lang') || 'id'

  const navigate = useNavigate();
  const handlers = useSwipeable({
    onSwipedLeft: () => navigate('/subtopic4/content3'),
    onSwipedRight: () => navigate('/subtopic4/content1'),
    trackMouse: true
  });
  return (
    <div className="subtopic4-container">
      <div className="subtopic4-header">
        ...
        <div className="subtopic4-arrows desktop-only">
          ...
          <Link to="/subtopic4/content1" className="subtopic4-arrow-btn" >
            <MdChevronLeft />
          </Link>
