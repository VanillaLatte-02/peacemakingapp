...
export default function Subtopic4Content5() {
  const lang = localStorage.getItem('lang') || 'id'

  const navigate = useNavigate();
  const handlers = useSwipeable({
    onSwipedLeft: () => navigate('/subtopic4/content6'),
    onSwipedRight: () => navigate('/subtopic4/content4'),
    trackMouse: true
  });
  return (
    <div className="subtopic4-container">
      <div className="subtopic4-header">
        ...
        <div className="subtopic4-arrows desktop-only">
          ...
          <Link to="/subtopic4/content4" className="arrow-btn" >
            <MdChevronLeft  />
          </Link>
          <Link to="/subtopic4/content6" className="arrow-btn" >
            <MdChevronRight />
          </Link>
