...
export default function Subtopic2Content3() {
  const lang = localStorage.getItem('lang') || 'id'

  const navigate = useNavigate();
  const handlers = useSwipeable({
    onSwipedLeft: () => navigate('/subtopic2/content4'),
    onSwipedRight: () => navigate('/subtopic2/content2'),
    trackMouse: true
  });
  return (
    <div className="subtopic2-container">
      <div className="subtopic2-header">
        ...
        <div className="subtopic2-arrows desktop-only">
          ...
          <Link to="/subtopic2/content2" className="subtopic2-arrow-btn" >
            <MdChevronLeft />
          </Link>
          <Link to="/subtopic2/content4" className="subtopic2-arrow-btn" >
            <MdChevronRight />
          </Link>
