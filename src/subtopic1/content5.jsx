...
export default function Subtopic1Content5() {
  const lang = localStorage.getItem('lang') || 'en'

  const navigate = useNavigate();
  const handlers = useSwipeable({
    onSwipedLeft: () => navigate('/subtopic1/content6'),
    onSwipedRight: () => navigate('/subtopic1/content4'),
    trackMouse: true
  });
  return (
    <div className="subtopic1-container">
      <div className="subtopic1-header">
        ...
        <div className="subtopic1-arrows desktop-only">
          ...
          <Link to="/subtopic1/content4" className="subtopic1-arrow-btn" >
            <MdChevronLeft />
          </Link>
