...
export default function Subtopic1Content6() {
  const lang = localStorage.getItem('lang') || 'id'

  const navigate = useNavigate();
  const handlers = useSwipeable({
    onSwipedLeft: () => navigate('/subtopic1/content7'),
    onSwipedRight: () => navigate('/subtopic1/content5'),
    trackMouse: true
  });
  return (
    <div className="subtopic1-container">
      <div className="subtopic1-header">
        ...
        <div className="subtopic1-arrows desktop-only">
          ...
          <Link to="/subtopic1/content5" className="subtopic1-arrow-btn" >
            <MdChevronLeft />
          </Link>
          <Link to="/subtopic1/content7" className="subtopic1-arrow-btn" >
            <MdChevronRight />
          </Link>
