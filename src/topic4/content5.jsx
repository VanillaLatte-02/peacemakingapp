...
export default function Topic4Content5() {
  const lang = localStorage.getItem('lang') || 'id'

  const navigate = useNavigate();
  const handlers = useSwipeable({
    onSwipedLeft: () => navigate('/topic4/content6'),
    onSwipedRight: () => navigate('/topic4/content4'),
    trackMouse: true
  });
  return (
    <div className="topic4-container">
      <div className="topic4-header">
        ...
        <div className="topic4-arrows desktop-only">
          ...
          <Link to="/topic4/content6" className="arrow-btn" >
            <MdChevronRight />
          </Link>
