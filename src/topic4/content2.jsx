...
export default function Topic4Content2() {
  const lang = localStorage.getItem('lang') || 'id'

  const navigate = useNavigate();
  const handlers = useSwipeable({
    onSwipedLeft: () => navigate('/topic4/content3'),
    onSwipedRight: () => navigate('/topic4/content1'),
    trackMouse: true
  });
  return (
    <div className="topic4-container">
      <div className="topic4-header">
        ...
        <div className="topic4-arrows desktop-only">
          ...
          <Link to="/topic4/content1" className="topic4-arrow-btn" >
            <MdChevronLeft />
          </Link>
          <Link to="/topic4/content3" className="topic4-arrow-btn" >
            <MdChevronRight />
          </Link>
