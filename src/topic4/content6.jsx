...
export default function Topic4Content6() {
  const lang = localStorage.getItem('lang') || 'en'

  const navigate = useNavigate();
  const handlers = useSwipeable({
    onSwipedLeft: () => navigate('/topic4/content7'),
    onSwipedRight: () => navigate('/topic4/content5'),
    trackMouse: true
  });
  return (
    <div className="topic4-container">
      <div className="topic4-header">
        ...
        <div className="topic4-arrows desktop-only">
          ...
          <Link to="/topic4/content5" className="topic4-arrow-btn" >
            <MdChevronLeft />
          </Link>
          <Link to="/topic4/content7" className="topic4-arrow-btn" >
            <MdChevronRight />
          </Link>
